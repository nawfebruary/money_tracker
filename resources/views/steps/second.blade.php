...
@section('content')
    <div class="stepper stepper-links d-flex flex-column">
        ...
        <!--end::Nav-->
        <form class="mx-auto mw-500px w-100 pt-15" action={{ route('register.second-step.create') }} method="POST">
            @csrf
            <!--begin::Wrapper-->
            <div class="w-100">
                <!--begin::Heading-->
                ...
                <div class="fv-row d-flex align-items-center justify-content-center mb-5" data-kt-buttons="true">
                    <!--begin::Option-->
                    <label id='rentOwn' class="btn btn-md btn-success w-50 me-2">
                        <!--begin::Input-->
                    ...
                    <!--end::Option-->
                    <!--begin::Option-->
                    <label id='rentOwn' class="btn btn-md btn-danger w-50">
                        <!--begin::Input-->
                ...
                <div class="d-flex flex-stack">
                    <a href="{{ route('register.first-step.create', ['param' => true]) }}"
                        class="btn btn-lg btn-light me-3">Back</a>  --}}
                    <button type="subimit" class="btn btn-lg btn-primary d-none" id="second_next">
...
@section('script')
    <script>
        $(document).ready(function() {
            $(document).on('click', '#rentOwn', function(event) {
                $('#second_next').click();
            })
        })
    </script>
