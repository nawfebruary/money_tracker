<x-app-layout>
    ...
    <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
        ...
        <div class="post d-flex flex-column-fluid" id="kt_post">
            ...
            <div id="kt_content_container" class="container-xxl">
                <!-- Session Status -->
                <x-auth-session-status class="badge-light-success text-lg p-5 mt-5" :status="session('status')" />

                <!-- Validation Errors -->
                <x-auth-validation-errors class="badge-light-danger text-lg p-5 mt-5" :errors="$errors" />

                <!--begin::Row-->
                <div class="row g-5 g-xl-10 mb-xl-10 mt-3 md-lg-3">
                    <div class="col-lg-12 col-xl-12 col-xxl-12 mb-5 mb-xl-0">
                        ...
                        <div class="card card-flush h-md-100 mb-5 mb-xl-10">
                            ...
                            <div class="card-header pt-5">
                                ...
                                <div class="card-title d-flex flex-column">
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <!--begin::Amount-->
                                        <span
                                            class="fs-2hx fw-bolder text-dark me-2 lh-1 ls-n2">{{ addCurrency($sumOfIncome - $sumOfExpense) }}</span>
                                        <!--end::Amount-->
                                        {{-- <!--begin::Badge-->
                                    ...
                                    <!--end::Info-->
                                    <!--begin::Subtitle-->
                                    <span class="text-gray-400 pt-1 fw-bold fs-6">Balance</span>
                                    <!--end::Subtitle-->
                                </div>
                                <!--end::Title-->
                            </div>
                            <!--end::Header-->
                            <!--begin::Card body-->
                            <div class="card-body pt-2 d-flex flex-column mb-0 pb-5 pb-md-0">
                                <div
                                    class="pt-2 d-flex align-items-center justify-content-center flex-wrap flex-md-nowrap">

                                    <!--begin::Chart-->
                                    <div class="d-flex flex-center me-5 pt-2 col-12 col-md-6 ">
                                        @if ($sumOfIncome === 0 && $sumOfExpense === 0)
                                            <h1 class="d-flex text-dark fw-bolder fs-3 align-items-center">
                                                {{ __('No data to display') }}</h1>
                                        @else
                                            <canvas id="transaction_chart" class='h-100'></canvas>
                                        @endif
                                    </div>
                                    <!--end::Chart-->

                                    <!--begin::Labels-->
                                    <div class="d-flex flex-column justify-content-center align-items-center  align-items-md-start col-12 col-md-6">
                                        <!--begin::Label-->
                                        <div
                                            class="d-flex fs-6 fw-bold align-items-center justify-content-center mt-3 col-8 col-lg-6">
                                            <!--begin::Bullet-->
                                            <div class="bullet w-8px h-6px rounded-2 bg-success me-3"></div>
                                            <!--end::Bullet-->
                                            <!--begin::Label-->
                                            <div class="text-gray-500 flex-grow-1 me-4">Income</div>
                                            <!--end::Label-->
                                            <!--begin::Stats-->
                                            <div class="fw-boldest text-gray-700 text-xxl-end">
                                                {{ addCurrency($sumOfIncome) }}</div>
                                            <!--end::Stats-->
                                        </div>
                                        <!--end::Label-->
                                        <!--begin::Label-->
                                ...
                                <div class='border-top-1 my-10'> </div>

                                <div class="d-flex align-items-center justify-content-center">
                                    <a href="#" class="btn btn-md btn-success w-50 me-2" data-bs-toggle="modal"
                                        data-bs-target="#kt_modal_income">Add Income</a>
                                    @if ($sumOfIncome - $sumOfExpense <= 0)
                                        <button class="btn btn-md btn-danger w-50 " @disabled(true)>Add
                                            Expense</button>
                                    @else
                                        <a href="#" class="btn btn-md btn-danger w-50" data-bs-toggle="modal"
                                            id="addExpense" data-bs-target="#kt_modal_expense">Add Expense</a>
                                    @endif
                                </div>
                            ...
                            {{-- <div class="container-fluid p-0 d-flex align-items-center justify-content-center">
                                <a href="#" class="btn btn-md btn-success w-50 rounded-0" data-bs-toggle="modal" style="border-bottom-left-radius: .475rem !important;"
                                    data-bs-target="#kt_modal_income">Add Income</a>
                                @if ($sumOfIncome - $sumOfExpense <= 0)
                                    <button class="btn btn-md btn-danger w-50 rounded-0" @disabled(true) style="border-bottom-right-radius: .475rem !important;">Add Expense</button>
                                @else
                                    <a href="#" class="btn btn-md btn-danger w-50 rounded-0" style="border-bottom-right-radius: .475rem !important;" data-bs-toggle="modal"
                                        id="addExpense" data-bs-target="#kt_modal_expense">Add Expense</a>
                                @endif
                            </div> --}}
                        </div>
                ...
                <div id="pagination_data">
                    @include('dashboard.transactions-pagination', [
                        'transactions' => $transactions,
                        'count' => $count,
                    ])
                </div>

                <!--begin::Income Expense Bar Chart-->
                        ...
                        <div class="card card-flush h-xl-100">
                            ...
                            <div class="card-header pt-7">
                                ...
                                <h3 class="card-title align-items-start flex-column">
                                    <span class="card-label fw-bolder text-dark">Weekly Chart</span>
                                </h3>
                            ...
                            <div class="card-body">
                                <div id="loading" class="d-block">
                                    <p class="fw-bolder text-gray-600 text-center">Processing ... </p>
                                </div>
                                <div id="weekly-chart" class="d-none">
                                    <canvas id="incomeExpenseChart" class="mh-450px w-600px w-md-100 mx-auto my-0"></canvas>
                                </div>
                            </div>
                            <!--end::Card body-->
                        </div>
                ...
                <!--begin::Modal - income-->
                @include('dashboard.income-modal',[
                    'categories' => $categories,
                ])
                <!--end::Modal - Offer A income-->

                <!--begin::Modal - expense-->
                @include('dashboard.expense-modal',[
                    'categories' => $categories,
                ])
                <!--end::Modal - Offer A expense-->
    ...
    @section('scripts')
        <script>
            ...
            var sumOfIncome = {!! json_encode($sumOfIncome) !!}
            var sumOfExpense = {!! json_encode($sumOfExpense) !!}
            transactionDonutChart([sumOfIncome, sumOfExpense])
            ...
            $.ajax({
                ...
                document.getElementById('weekly-chart').classList.remove('d-none');
                document.getElementById('weekly-chart').classList.add('d-block');

                incomeExpenseBarchart(data.months, data.incomes, data.expenses);
            }).fail(function() {
                document.getElementById('loading').innerHTML = "Failed! ";
            });
        </script>
    @endsection
